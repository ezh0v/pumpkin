...
To build the project from source, see the [Development Guidelines](https://github.com/ezh0v/pumpkin/wiki/Development-Guidelines) section in the wiki.

## Licenses

- The source code is licensed under the [GPLv3 License](LICENSE).

- The [logo](https://www.svgrepo.com/svg/215601/pumpkin) is licensed under the [CC0 License](https://www.svgrepo.com/page/licensing/#CC0).
